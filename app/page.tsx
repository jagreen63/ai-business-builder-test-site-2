  ...
  return (
    <main className="flex flex-col items-center justify-center min-h-screen bg-gray-100">
      <section className="text-center mt-10">
        <h1 className="text-4xl font-bold text-gray-800">Transform Your Austin Property with Expert Pressure Washing</h1>
        <h2 className="text-xl text-gray-600 mt-2">Fast, Reliable Pressure Washing for Homes and Businesses</h2>
      ...
      <section className="mt-10">
        ...
        <ul className="list-disc list-inside mt-2 text-gray-600">
          ...
          <li>Fast Response and Scheduling</li>
        </ul>
      </section>
    </main>
  );
