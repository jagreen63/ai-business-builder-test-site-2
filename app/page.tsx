  ...
  return (
    <main className="flex flex-col items-center justify-center min-h-screen bg-gray-100">
      <section className="text-center mt-10">
        <h1 className="text-4xl font-bold text-gray-800">Top-Notch Pressure Washing in Charlotte, NC</h1>
        <h2 className="text-xl text-gray-600 mt-2">Revitalize Your Home or Business with Our Expert Services</h2>
