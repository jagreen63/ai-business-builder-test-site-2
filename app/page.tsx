  ...
  return (
    <main className="flex flex-col items-center justify-center min-h-screen bg-gray-100">
      <section className="text-center mt-10">
        <h1 className="text-4xl font-bold text-gray-800">Revitalize Your Property with Expert Pressure Washing in Phoenix, AZ</h1>
        <h2 className="text-xl text-gray-600 mt-2">Get a sparkling clean home or business with our fast and reliable service</h2>
